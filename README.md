...
1. & 2. Set an initial state value through a reducer and render a list of todos from that state
3. Add a form that dispatches an "ADD_TODO" action to be able to add a todo item to your list
4. Build a function that let's you mark todo items as completed when you click on them
5. Build a function that let's you clear completed todos when you click on a "Clear Completed" button
